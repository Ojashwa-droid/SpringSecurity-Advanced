...
public class OjasBankProdUsernamePwdAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        if (passwordEncoder.matches(pwd, userDetails.getPassword())) {
            // Fetch the age details and perform validations based on your business requirements.
